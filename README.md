...
```
julia> Implicit3DPlotting.plot_implicit_surface(g; cutoffmap=x->x[1]^2+x[2]^2+x[3]^2-3>=0, samples=(250,250,250),
       transparency=false, zcolormap=:viridis, xlims=(-1.25,1.25), ylims=(-1.25,1.25), zlims=(-1.25,1.25))
```

which produces the following picture:
<p align="center">
  <img src="https://github.com/matthiashimmelmann/Implicit3DPlotting.jl/blob/main/img/cayleyquadric.png" width="600", height="600">
</p>
