...
```julia
julia> ]
(@v1.12) pkg> add Implicit3DPlotting
```
...
- For surfaces: We can adjust the lighting of the scene using the parameters `diffuse = Vec3f(1.1)`, `specular = Vec3f(0.8)`, `shininess = 60f0` and `backlight = 4f0`.
