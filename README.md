...
- For surfaces: Add a color map dependent on the <img src="https://render.githubusercontent.com/render/math?math=z">-value by `zcolormap = :viridis` (for other color schemes, see https://docs.juliaplots.org/latest/generated/colorschemes/),
